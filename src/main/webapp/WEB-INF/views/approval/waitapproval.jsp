...
<main> 
<form id='actionForm' action="/approval/waitapprovalload" method='get'>
...
<table id="waitlist">
			...
			<tbody id="waittable">
			 ...
			 <c:forEach var="wait" items="${waitApprovalList}">
			  <tr value="${wait.approvalNo}">
			            <td>
			               ${wait.approvalNo}
			            </td>
			             <td>
			             <fmt:formatDate value="${wait.reportingDate}" pattern="yyyy-MM-dd" />			               
			            </td>
			             <td>
			                <a href="/approval/viewapproval?ano=${wait.approvalNo}">${wait.title}</a>
			            </td>
			             <td>
			             ${wait.writerName}			             
			            </td>
...
<script src ="/resources/js/waitapprovallist.js"></script>
</body>
</html>