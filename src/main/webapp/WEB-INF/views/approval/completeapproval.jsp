...
<main> 
<form id='actionForm' action="/approval/completeapprovalload" method='get'>
...
<table id="waitlist">
			...
			<tbody id="waittable">
			 ...
			 <c:forEach var="complete" items="${completeApprovalList}">
			  <tr value="${complete.approvalNo}">
			            <td>
			               ${complete.approvalNo}
			            </td>
			             <td>
			             <fmt:formatDate value="${complete.reportingDate}" pattern="yyyy-MM-dd" />			               
			            </td>
			             <td>
			                <a href="/approval/viewcompleteapproval?ano=${complete.approvalNo}">${complete.title}</a>
			            </td>
			             <td>
			             ${complete.writer}			             
			            </td>
...
<script src ="/resources/js/completeapprovallist.js"></script>
</body>
</html>